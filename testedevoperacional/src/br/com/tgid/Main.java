 ...
 *Necessário para o código ficar mais limpo ordernar corretamente as empresas produtos para que haja facilidade na visualização do código
 *Necessário fazer pastas segundo a convenção para o projeto
 *Nomes dos produtos devem estar corretamente digitados
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Produto produto2 = new Produto(2, "Sonho", 5, 8.50, empresa);
		Produto produto3 = new Produto(3, "Croissant", 7, 6.50, empresa);
